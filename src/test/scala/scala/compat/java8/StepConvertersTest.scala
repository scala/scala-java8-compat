...
class StepConvertersTest {
  ...
  def comprehensivelyGeneric() {
    ...
    good( co.Map[String, String]("fish" -> "salmon").keyStepper )
    good( co.Map[String, String]("fish" -> "salmon").valueStepper )
    ...
    good( co.SortedMap[String, String]("fish" -> "salmon").keyStepper )
    good( co.SortedMap[String, String]("fish" -> "salmon").valueStepper )
    ...
    good( (ci.HashMap[String, String]("fish" -> "salmon"): ci.AbstractMap[String, String]).keyStepper )
    good( (ci.HashMap[String, String]("fish" -> "salmon"): ci.AbstractMap[String, String]).valueStepper )
    ...
    good( ci.IntMap[String](123456 -> "salmon").valueStepper )
    ...
    good( ci.ListMap[String, String]("fish" -> "salmon").keyStepper )
    good( ci.ListMap[String, String]("fish" -> "salmon").valueStepper )
    IFFY( ci.ListSet[String]("salmon").stepper )
    IFFY( ci.LongMap[String](9876543210L -> "salmon").stepper )
    good( ci.LongMap[String](9876543210L -> "salmon").valueStepper )
    IFFY( ci.Map[String, String]("fish" -> "salmon").stepper )
    good( ci.Map[String, String]("fish" -> "salmon").keyStepper )
    good( ci.Map[String, String]("fish" -> "salmon").valueStepper )
    ...
    good( ci.SortedMap[String, String]("fish" -> "salmon").keyStepper )
    good( ci.SortedMap[String, String]("fish" -> "salmon").valueStepper )
    ...
    good( ci.TreeMap[String, String]("fish" -> "salmon").keyStepper )
    good( ci.TreeMap[String, String]("fish" -> "salmon").valueStepper )
    ...
    good( (cm.HashMap[String, String]("fish" -> "salmon"): cm.AbstractMap[String, String]).keyStepper )
    good( (cm.HashMap[String, String]("fish" -> "salmon"): cm.AbstractMap[String, String]).valueStepper )
    ...
    good( cm.AnyRefMap[String,String]("fish" -> "salmon").keyStepper )
    good( cm.AnyRefMap[String,String]("fish" -> "salmon").valueStepper )
    ...
    good( cm.LongMap[String](9876543210L -> "salmon").valueStepper )
    IFFY( cm.Map[String, String]("fish" -> "salmon").stepper )
    good( cm.Map[String, String]("fish" -> "salmon").keyStepper )
    good( cm.Map[String, String]("fish" -> "salmon").valueStepper )
    good( cm.MutableList[String]("salmon").stepper )
    IFFY( cm.OpenHashMap[String, String]("fish" -> "salmon").stepper )
    good( cm.OpenHashMap[String, String]("fish" -> "salmon").keyStepper )
    good( cm.OpenHashMap[String, String]("fish" -> "salmon").valueStepper )
    ...
    good( cm.WeakHashMap[String, String]("fish" -> "salmon").keyStepper )
    good( cm.WeakHashMap[String, String]("fish" -> "salmon").valueStepper )
  ...
  def comprehensivelyDouble() {
    ...
    good( co.Map[Double, Double](2.718281828 -> 3.14159).keyStepper )
    good( co.Map[Double, Double](2.718281828 -> 3.14159).valueStepper )
    IFFY( co.Seq[Double](3.14159).stepper )
    IFFY( co.Seq[Double](3.14159).view.stepper )
    IFFY( co.Set[Double](3.14159).stepper )
    good( co.SortedMap[Double, Double](2.718281828 -> 3.14159).keyStepper )
    good( co.SortedMap[Double, Double](2.718281828 -> 3.14159).valueStepper )
    ...
    good( (ci.HashMap[Double, Double](2.718281828 -> 3.14159): ci.AbstractMap[Double, Double]).keyStepper )
    good( (ci.HashMap[Double, Double](2.718281828 -> 3.14159): ci.AbstractMap[Double, Double]).valueStepper )
    ...
    good( ci.IntMap[Double](123456 -> 3.14159).valueStepper )
    IFFY( ci.Iterable[Double](3.14159).stepper )
    good( ci.LinearSeq[Double](3.14159).stepper )
    good( ci.List[Double](3.14159).stepper )
    good( ci.ListMap[Double, Double](2.718281828 -> 3.14159).keyStepper )
    good( ci.ListMap[Double, Double](2.718281828 -> 3.14159).valueStepper )
    IFFY( ci.ListSet[Double](3.14159).stepper )
    good( ci.LongMap[Double](9876543210L -> 3.14159).valueStepper )
    good( ci.Map[Double, Double](2.718281828 -> 3.14159).keyStepper )
    good( ci.Map[Double, Double](2.718281828 -> 3.14159).valueStepper )
    good( ci.Queue[Double](3.14159).stepper )
    IFFY( ci.Seq[Double](3.14159).stepper )
    IFFY( ci.Set[Double](3.14159).stepper )
    good( ci.SortedMap[Double, Double](2.718281828 -> 3.14159).keyStepper )
    good( ci.SortedMap[Double, Double](2.718281828 -> 3.14159).valueStepper )
    ...
    good( ci.TreeMap[Double, Double](2.718281828 -> 3.14159).keyStepper )
    good( ci.TreeMap[Double, Double](2.718281828 -> 3.14159).valueStepper )
    ...
    good( (cm.HashMap[Double, Double](2.718281828 -> 3.14159): cm.AbstractMap[Double, Double]).keyStepper )
    good( (cm.HashMap[Double, Double](2.718281828 -> 3.14159): cm.AbstractMap[Double, Double]).valueStepper )
    ...
    good( cm.AnyRefMap[String,Double]("fish" -> 3.14159).valueStepper )
    ...
    good( cm.ListMap[Double, Double](2.718281828 -> 3.14159).keyStepper )
    good( cm.ListMap[Double, Double](2.718281828 -> 3.14159).valueStepper )
    good( cm.LongMap[Double](9876543210L -> 3.14159).valueStepper )
    good( cm.Map[Double, Double](2.718281828 -> 3.14159).keyStepper )
    good( cm.Map[Double, Double](2.718281828 -> 3.14159).valueStepper )
    good( cm.MutableList[Double](3.14159).stepper )
    good( cm.OpenHashMap[Double, Double](2.718281828 -> 3.14159).keyStepper )
    good( cm.OpenHashMap[Double, Double](2.718281828 -> 3.14159).valueStepper )
    ...
    good( cm.WeakHashMap[Double, Double](2.718281828 -> 3.14159).keyStepper )
    good( cm.WeakHashMap[Double, Double](2.718281828 -> 3.14159).valueStepper )
    good( (Array(3.14159): cm.WrappedArray[Double]).stepper )

    // Java 6 converters section

    // Concurrent section
    good( cc.TrieMap[Double, Double](2.718281828 -> 3.14159).keyStepper )
    good( cc.TrieMap[Double, Double](2.718281828 -> 3.14159).valueStepper )
    good( (cc.TrieMap[Double, Double](2.718281828 -> 3.14159): cc.Map[Double, Double]).keyStepper )
    good( (cc.TrieMap[Double, Double](2.718281828 -> 3.14159): cc.Map[Double, Double]).valueStepper )
  }
  ...
  def comprehensivelyInt() {
    ...
    good( ci.IntMap[String](123456 -> "salmon").keyStepper )
    good( ci.IntMap[Double](123456 -> 3.14159).keyStepper )
    good( ci.IntMap[Long](123456 -> 0x123456789L).keyStepper )
    ...
    good( co.Map[Int, Int](0xDEEDED -> 654321).keyStepper )
    good( co.Map[Int, Int](0xDEEDED -> 654321).valueStepper )
    IFFY( co.Seq[Int](654321).stepper )
    IFFY( co.Seq[Int](654321).view.stepper )
    IFFY( co.Set[Int](654321).stepper )
    good( co.SortedMap[Int, Int](0xDEEDED -> 654321).keyStepper )
    good( co.SortedMap[Int, Int](0xDEEDED -> 654321).valueStepper )
    ...
    good( (ci.HashMap[Int, Int](0xDEEDED -> 654321): ci.AbstractMap[Int, Int]).keyStepper )
    good( (ci.HashMap[Int, Int](0xDEEDED -> 654321): ci.AbstractMap[Int, Int]).valueStepper )
    ...
    good( ci.IntMap[Int](123456 -> 654321).keyStepper )
    good( ci.IntMap[Int](123456 -> 654321).valueStepper )
    IFFY( ci.Iterable[Int](654321).stepper )
    good( ci.LinearSeq[Int](654321).stepper )
    good( ci.List[Int](654321).stepper )
    good( ci.ListMap[Int, Int](0xDEEDED -> 654321).keyStepper )
    good( ci.ListMap[Int, Int](0xDEEDED -> 654321).valueStepper )
    IFFY( ci.ListSet[Int](654321).stepper )
    good( ci.LongMap[Int](9876543210L -> 654321).valueStepper )
    good( ci.Map[Int, Int](0xDEEDED -> 654321).keyStepper )
    good( ci.Map[Int, Int](0xDEEDED -> 654321).valueStepper )
    good( ci.Queue[Int](654321).stepper )
    IFFY( ci.Seq[Int](654321).stepper )
    IFFY( ci.Set[Int](654321).stepper )
    good( ci.SortedMap[Int, Int](0xDEEDED -> 654321).keyStepper )
    good( ci.SortedMap[Int, Int](0xDEEDED -> 654321).valueStepper )
    ...
    good( ci.TreeMap[Int, Int](0xDEEDED -> 654321).keyStepper )
    good( ci.TreeMap[Int, Int](0xDEEDED -> 654321).valueStepper )
    ...
    good( (cm.HashMap[Int, Int](0xDEEDED -> 654321): cm.AbstractMap[Int, Int]).keyStepper )
    good( (cm.HashMap[Int, Int](0xDEEDED -> 654321): cm.AbstractMap[Int, Int]).valueStepper )
    IFFY( (cm.ArrayBuffer[Int](654321): cm.AbstractSeq[Int]).stepper )
    IFFY( (cm.HashSet[Int](654321): cm.AbstractSet[Int]).stepper )
    good( cm.AnyRefMap[String, Int]("fish" -> 654321).valueStepper )
    ...
    good( cm.ListMap[Int, Int](0xDEEDED -> 654321).keyStepper )
    good( cm.ListMap[Int, Int](0xDEEDED -> 654321).valueStepper )
    good( cm.LongMap[Int](9876543210L -> 654321).valueStepper )
    good( cm.Map[Int, Int](0xDEEDED -> 654321).keyStepper )
    good( cm.Map[Int, Int](0xDEEDED -> 654321).valueStepper )
    good( cm.MutableList[Int](654321).stepper )
    good( cm.OpenHashMap[Int, Int](0xDEEDED -> 654321).keyStepper )
    good( cm.OpenHashMap[Int, Int](0xDEEDED -> 654321).valueStepper )
    ...
    good( cm.WeakHashMap[Int, Int](0xDEEDED -> 654321).keyStepper )
    good( cm.WeakHashMap[Int, Int](0xDEEDED -> 654321).valueStepper )
    good( (Array(654321): cm.WrappedArray[Int]).stepper )

    // Java 6 converters section

    // Concurrent section
    good( cc.TrieMap[Int, Int](0xDEEDED -> 654321).keyStepper )
    good( cc.TrieMap[Int, Int](0xDEEDED -> 654321).valueStepper )
    good( (cc.TrieMap[Int, Int](0xDEEDED -> 654321): cc.Map[Int, Int]).keyStepper )
    good( (cc.TrieMap[Int, Int](0xDEEDED -> 654321): cc.Map[Int, Int]).valueStepper )
  }
  ...
  def comprehensivelyLong() {
    ...
    good( ci.LongMap[String](9876543210L -> "salmon").keyStepper )
    good( cm.LongMap[String](9876543210L -> "salmon").keyStepper )
    good( ci.LongMap[Double](9876543210L -> 3.14159).keyStepper )
    good( cm.LongMap[Double](9876543210L -> 3.14159).keyStepper )
    good( ci.LongMap[Int](9876543210L -> 654321).keyStepper )
    good( cm.LongMap[Int](9876543210L -> 654321).keyStepper )
    ...
    good( co.Map[Long, Long](1234567654321L -> 0x123456789L).keyStepper )
    good( co.Map[Long, Long](1234567654321L -> 0x123456789L).valueStepper )
    IFFY( co.Seq[Long](0x123456789L).stepper )
    IFFY( co.Seq[Long](0x123456789L).view.stepper )
    IFFY( co.Set[Long](0x123456789L).stepper )
    good( co.SortedMap[Long, Long](1234567654321L -> 0x123456789L).keyStepper )
    good( co.SortedMap[Long, Long](1234567654321L -> 0x123456789L).valueStepper )
    ...
    good( (ci.HashMap[Long, Long](1234567654321L -> 0x123456789L): ci.AbstractMap[Long, Long]).keyStepper )
    good( (ci.HashMap[Long, Long](1234567654321L -> 0x123456789L): ci.AbstractMap[Long, Long]).valueStepper )
    ...
    good( ci.IntMap[Long](123456 -> 0x123456789L).valueStepper )
    ...
    good( ci.ListMap[Long, Long](1234567654321L -> 0x123456789L).keyStepper )
    good( ci.ListMap[Long, Long](1234567654321L -> 0x123456789L).valueStepper )
    IFFY( ci.ListSet[Long](0x123456789L).stepper )
    good( ci.LongMap[Long](9876543210L -> 0x123456789L).keyStepper )
    good( ci.LongMap[Long](9876543210L -> 0x123456789L).valueStepper )
    good( ci.Map[Long, Long](1234567654321L -> 0x123456789L).keyStepper )
    good( ci.Map[Long, Long](1234567654321L -> 0x123456789L).valueStepper )
    good( ci.Queue[Long](0x123456789L).stepper )
    IFFY( ci.Seq[Long](0x123456789L).stepper )
    IFFY( ci.Set[Long](0x123456789L).stepper )
    good( ci.SortedMap[Long, Long](1234567654321L -> 0x123456789L).keyStepper )
    good( ci.SortedMap[Long, Long](1234567654321L -> 0x123456789L).valueStepper )
    ...
    good( ci.TreeMap[Long, Long](1234567654321L -> 0x123456789L).keyStepper )
    good( ci.TreeMap[Long, Long](1234567654321L -> 0x123456789L).valueStepper )
    ...
    good( (cm.HashMap[Long, Long](1234567654321L -> 0x123456789L): cm.AbstractMap[Long, Long]).keyStepper )
    good( (cm.HashMap[Long, Long](1234567654321L -> 0x123456789L): cm.AbstractMap[Long, Long]).valueStepper )
    ...
    good( cm.AnyRefMap[String,Long]("fish" -> 0x123456789L).valueStepper )
    ...
    good( cm.ListMap[Long, Long](1234567654321L -> 0x123456789L).keyStepper )
    good( cm.ListMap[Long, Long](1234567654321L -> 0x123456789L).valueStepper )
    good( cm.LongMap[Long](9876543210L -> 0x123456789L).keyStepper )
    good( cm.LongMap[Long](9876543210L -> 0x123456789L).valueStepper )
    good( cm.Map[Long, Long](1234567654321L -> 0x123456789L).keyStepper )
    good( cm.Map[Long, Long](1234567654321L -> 0x123456789L).valueStepper )
    good( cm.MutableList[Long](0x123456789L).stepper )
    good( cm.OpenHashMap[Long, Long](1234567654321L -> 0x123456789L).keyStepper )
    good( cm.OpenHashMap[Long, Long](1234567654321L -> 0x123456789L).valueStepper )
    ...
    good( cm.WeakHashMap[Long, Long](1234567654321L -> 0x123456789L).keyStepper )
    good( cm.WeakHashMap[Long, Long](1234567654321L -> 0x123456789L).valueStepper )
    good( (Array(0x123456789L): cm.WrappedArray[Long]).stepper )

    // Java 6 converters section

    // Concurrent section
    good( cc.TrieMap[Long, Long](1234567654321L -> 0x123456789L).keyStepper )
    good( cc.TrieMap[Long, Long](1234567654321L -> 0x123456789L).valueStepper )
    good( (cc.TrieMap[Long, Long](1234567654321L -> 0x123456789L): cc.Map[Long, Long]).keyStepper )
    good( (cc.TrieMap[Long, Long](1234567654321L -> 0x123456789L): cc.Map[Long, Long]).valueStepper )
 }
