...
class StepConvertersTest {
  ...
  def comprehensivelyGeneric() {
    ...
    good( ci.LinearSeq[String]("salmon").stepper )
    good( ci.List[String]("salmon").stepper )
    ...
    good( ci.Queue[String]("salmon").stepper )
    ...
    good( ci.Stack[String]("salmon").stepper )
    good( ci.Stream[String]("salmon").stepper )
    ...
    good( cm.LinearSeq[String]("salmon").stepper )
  ...
  def comprehensivelyDouble() {
    ...
    good( ci.LinearSeq[Double](3.14159).stepper )
    good( ci.List[Double](3.14159).stepper )
    ...
    good( ci.Queue[Double](3.14159).stepper )
    ...
    good( ci.Stack[Double](3.14159).stepper )
    good( ci.Stream[Double](3.14159).stepper )
    ...
    good( cm.LinearSeq[Double](3.14159).stepper )
  ...
  def comprehensivelyInt() {
    ...
    good( ci.LinearSeq[Int](654321).stepper )
    good( ci.List[Int](654321).stepper )
    ...
    good( ci.Queue[Int](654321).stepper )
    ...
    good( ci.Stack[Int](654321).stepper )
    good( ci.Stream[Int](654321).stepper )
    ...
    good( cm.LinearSeq[Int](654321).stepper )
  ...
  def comprehensivelyLong() {
    ...
    good( ci.LinearSeq[Long](0x123456789L).stepper )
    good( ci.List[Long](0x123456789L).stepper )
    ...
    good( ci.Queue[Long](0x123456789L).stepper )
    ...
    good( ci.Stack[Long](0x123456789L).stepper )
    good( ci.Stream[Long](0x123456789L).stepper )
    ...
    good( cm.LinearSeq[Long](0x123456789L).stepper )
